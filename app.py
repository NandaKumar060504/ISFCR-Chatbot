...
def create_compression_retriever(base_compressor,base_retriever):
    ...
    What the function does: creates a document compressor pipeline by taking filters as transformers
    what the functions return: It returns compressed document pipeline"""
    compression_retriever_reordered = ContextualCompressionRetriever(base_compressor=base_compressor, base_retriever=base_retriever,search_kwargs={"k": 5, "include_metadata": True})
...
def create_ret_chain(llm,retriever,prompt_temp):
    """
    Args: llm, retriever, prompt_templete
    What the function does: creates a QA retriever chain which takes llm, retriever and prompt Templete as inputs
    what the functions return: It returns qa retriever chain"""
...
def create_prompt_template(template):
    """
    Args: templete
    What the function does: creates a prompt templete and defines context and answer within the input
    what the functions return: It returns prompt templete"""
    prompt_temp = PromptTemplate.from_template(template)
    return prompt_temp
flag=False

def main():
    DB = "c:\\Users\\Aiml cse\\Desktop\\ISFCR_Codes\\db"
    flag=True
    ...
    if not(flag) :
        ...
        "https://www.isfcr.pes.edu/resources",
        "https://www.isfcr.pes.edu/team/prasad-b-honnavalli",
        "https://www.isfcr.pes.edu/team/preet-kanwal",
        "https://www.isfcr.pes.edu/team/indu-radhakrishnan",
        "https://www.isfcr.pes.edu/team/vadiraja-acharya",
        "https://www.isfcr.pes.edu/team/vanitha-g",
        "https://www.isfcr.pes.edu/team/dr.-ashok-kumar-patil",
        "https://www.isfcr.pes.edu/team/dr.-s.s.-iyengar",
        "https://www.isfcr.pes.edu/team/dr-nagasundari-s",
        "https://www.isfcr.pes.edu/team/revathi",
        "https://www.isfcr.pes.edu/team/dr.-shruti-jadon",
        "https://www.isfcr.pes.edu/team/sapna-v-m",
        "https://www.isfcr.pes.edu/team/dr.-radhika-m.-hirannaiah",
        "https://www.isfcr.pes.edu/team/sushma-e",
        "https://www.isfcr.pes.edu/team/charanraj-b-r",
        "https://www.isfcr.pes.edu/team/dr.-adithya-b",
        "https://www.isfcr.pes.edu/team/dr.-roopa-ravish",
        "https://www.isfcr.pes.edu/team/pavan-a-c",
        "https://www.isfcr.pes.edu/courses/computer-networks",
        "https://www.isfcr.pes.edu/courses/internet-of-things",
        "https://www.isfcr.pes.edu/courses/fundamentals-of-augmented-and-virtual-reality",
        "https://www.isfcr.pes.edu/courses/computer-network-security",
        "https://www.isfcr.pes.edu/courses/cyber-forensics",
        "https://www.isfcr.pes.edu/courses/wireless-network-communication",
        "https://www.isfcr.pes.edu/courses/topics-in-computer-and-network-security",
        "https://www.isfcr.pes.edu/courses/software-security",
        "https://www.isfcr.pes.edu/courses/cyber-security-essentials",
        "https://www.isfcr.pes.edu/courses/applied-cryptography",
        "https://www.isfcr.pes.edu/courses/computer-networks-laboratory",
        "https://www.isfcr.pes.edu/courses/applied-cryptography-(ug)",
        "https://www.isfcr.pes.edu/courses/advanced-computer-networks",
        "https://www.isfcr.pes.edu/courses/blockchain",
        "https://www.isfcr.pes.edu/courses/information-security",
        "https://www.isfcr.pes.edu/courses/virtual-reality-and-its-applications",
        "https://www.isfcr.pes.edu/courses/cryptography",
        "https://www.isfcr.pes.edu/courses/topics-in-cryptography",
        "https://www.isfcr.pes.edu/post/two-tier-securing-mechanism-against-web-application-attacks-project-presentation-to-citrix-ceo",
        "https://www.isfcr.pes.edu/post/preventing-community-outbreaks-from-silent-spreaders-of-covid-19-virus",
        "https://www.isfcr.pes.edu/post/have-you-thought-of-cybercrimes-during-the-covid-19-pandemic",
        "https://www.isfcr.pes.edu/post/homomorphic-encryption",
        "https://www.isfcr.pes.edu/post/do-you-know-about-the-underlying-system-attacked-by-stuxnet-worm-in-iran",
        "https://www.isfcr.pes.edu/resources/page/2",
        "https://www.isfcr.pes.edu/post/isfcr-gets-paper-published-1",
        ...
        template="""Answer the question based only on the following context. If you don't know the answer, just say that you don't know, don't try to make up an answer. Do not take repeated context. Do not repeat the answer. Always say "thanks for asking!" at the end of the answer. 
                    {context}
                    Question: {question}
                    Helpful Answer:"""
