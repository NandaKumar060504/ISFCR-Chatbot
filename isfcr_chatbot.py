...
pdf_url = "C:/Users/Aiml cse/Downloads/Research_Review_3.pdf" # also allowed is a file path e.g. /home/downloads/xyz.pdf
...
#     response = ollama.chat(model='mistral:instruct', messages=[{'role': 'user', 'content': formatted_prompt}], memory=memory)
